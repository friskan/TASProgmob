package ukdw.com.prototypeprogmob.Network;
...
public interface GetDataService {
    ...
    Call<DefaultResult> insert_mahasiswa_foto(
            ...
            @Field("alamat_mhs") String alamat_mhs,
            @Field("email_mhs") String email_mhs,
            @Field("foto_mhs") String foto_mhs,
            @Field("nim_progmob") String nim_progmob
    );
    ...
    @FormUrlEncoded
    @POST("/api/progmob/mahasiswa/updatewithforo")
    ...
    Call<DefaultResult> delete_mahasiswa(
            @Field("id") String id,
            @Field("nim_progmob") String nim_progmob
    );
